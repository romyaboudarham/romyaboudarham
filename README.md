...
|---|---|---|
[Web Canvas Performance Demo](https://github.com/romyaboudarham/canvas-performance-demo) | Demo using native HTML5 Canvas 2D to render a grid of high‑res images. Metrics and analysis of LOD, viewport culling, and runtime toggles. | HTML5 Canvas 2D, React, TypeScript, Vite, CSS |
